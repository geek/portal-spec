# ContainerPilot Portal OpenAPI Specification
[![Build Status](https://travis-ci.org/geek/portal-spec.svg?branch=master)](https://travis-ci.org/geek/portal-spec)
...
6. If you did everything correct, https://geek.github.io/portal-spec/ will lead to your new docs
...
- Preview spec version for branch `[branch]`: https://geek.github.io/portal-spec/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://geek.github.io/portal-spec/ with url from the message: `Server started <url>`
